...
public class personBorrow extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (methodsString.equals("history")) {
			...
			countsqlString= "select count(*) as B from libBorrowRec left join libbook on libBorrowRec.bookID = libbook.bookid where libBorrowRec.borrowerID = ? and libBorrowRec.isReturn = '未还'";
			rssqlString= "select * from libBorrowRec left join libbook on libBorrowRec.bookID = libbook.bookid where libBorrowRec.borrowerID = ? and libBorrowRec.isReturn = '未还'";
		} else {
			return;
		}
